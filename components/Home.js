...
import { getPopularFood, getTopCategory } from '../redux/actions/foodActions';
...
const Home = ({ navigation }) => {
    ...
    const { loading, success, categoriesList } = topCategory

    const getpopularFood = useSelector(state => state.popularFood)
    const { foodList } = getpopularFood
    ...
    const renderCategoryItem  = ({ item }) =>(
        <View style={[styles.categoryItemWrapper, {
            ...
            <Image source={{uri: (`http://192.168.1.14:8000${item.image}`)}} style={styles.categoryItemImage} />
                ...
                <SafeAreaView>
                    <View style={styles.headerWrapper}>    
                        <View style={{display:'flex', flexDirection: 'row'}}>
                            ...
                            <Feather name='search' size={24} color={colors.textDark} style={{marginRight: 5}}/>
                    </View>
                </SafeAreaView>
                                ...
                                onPress={()=>navigation.navigate('Details', {
                                    ...
                                    <View  
                                        ...
                                        <View style={styles.popularCardRight}> 
                                            <Image source={{uri: (`http://192.168.1.14:8000${item.images}`)}} style={styles.popularCardImage}/>
                                        </View>
                                    </View>
                                </TouchableOpacity>
                            ))
